import {UnitCompiler,lineToInlinePlainString,unitToInlinePlainString,stringToId,getLastGlobalOption} from '@ddu6/stc'
...
export const cd:UnitCompiler=async (unit,compiler)=>{
    ...
    function extractLabels(children:STDN,tag:string){
        const labels:Label[]=[]
        const main:STDNUnit={
